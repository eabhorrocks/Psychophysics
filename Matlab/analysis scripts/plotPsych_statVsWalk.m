function [hline,hdata] = plotPsych_statVsWalk(result_stat,result_walk,plotOptions_stat,plotOptions_walk)
...
%% plot data (STATIONARY)
result = result_stat;
plotOptions = plotOptions_stat;
plotOptions_stat.plotThresh = false;
...
%% plot data (WALKING)
result = result_walk;
plotOptions = plotOptions_walk;
plotOptions_walk.plotThresh = false;
plotOptions.dataSize  = 10000./sum(result.data(:,3));
if ~isfield(plotOptions,'dataColor'),      plotOptions.dataColor      = [0,105/255,170/255]; end
if ~isfield(plotOptions,'plotData'),       plotOptions.plotData       = 1;                   end
if ~isfield(plotOptions,'lineColor'),      plotOptions.lineColor      = [0,0,0];             end
