function [hline,hdata] = plotPsych_spdComp(result_spd1, result_spd2, result_spd3, plotOptions_spd1, plotOptions_spd2, plotOptions_spd3)
...
if ~isfield(plotOptions,'lineWidth'),      plotOptions.lineWidth      = 1;                   end
...
plotOptions.plotThresh = false;
result = result_spd1;
plotOptions.dataColor = plotOptions_spd1.dataColor;
plotOptions.lineColor = plotOptions_spd1.lineColor;
plotOptions.dataSize  = 10000./sum(result.data(:,3));
ymin = 0;
holdState = ishold(h);
if ~holdState
...
result = result_spd2;
plotOptions.dataColor = plotOptions_spd2.dataColor;
plotOptions.lineColor = plotOptions_spd2.lineColor;
...
result = result_spd3;
plotOptions.dataColor = plotOptions_spd3.dataColor;
plotOptions.lineColor = plotOptions_spd3.lineColor;
holdState = ishold(h);
if ~holdState
    cla(h);
end
