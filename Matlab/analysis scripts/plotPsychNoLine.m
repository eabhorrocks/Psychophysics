function [hline,hdata] = plotPsychNoLine(result,plotOptions)
...
if ~isfield(plotOptions,'xLabel'),         plotOptions.xLabel         = 'Coherence (kappa)';    end
if ~isfield(plotOptions,'yLabel'),         plotOptions.yLabel         = 'Proportion Forward Responses';end
