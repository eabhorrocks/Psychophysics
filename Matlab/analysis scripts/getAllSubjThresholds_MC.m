...
xlabel('Positive Coherence')
ylabel('Negative Coherence')
...
grid on, box off
ylabel('Combined direction coherence')
...
cat2 = categorical({'Pos Coherence', 'Neg Coherence'});
cat2 = reordercats(cat2, {'Pos Coherence', 'Neg Coherence'});
...
ylabel('Coherence')
xlabel('Direction')
title('Mean 80% Coherence Threshold, collapsed over velocity')
[h,p] = ttest(vn,vp);
text(1.5, 1.8,string(['p = ' num2str(p)]),'HorizontalAlignment','Center')
