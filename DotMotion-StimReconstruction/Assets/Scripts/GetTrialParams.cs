...
public class GetTrialParams : MonoBehaviour
{
    ...
    public static GetTrialParams Instance { get; private set; }
    private void Awake()
    {
    ...
    void Connection()
    {
        ...
        if (exData[0] == "gp")
        {
            ...
            float feedbacktemp = float.Parse(exData[5]);
            pauseN = float.Parse(exData[6]);
            if (feedbacktemp == 1)
            {
                showFeedback = true;
            }
        ...
        else
        {
            ...
            walk = (exData[3]);
            coherence = Convert.ToDouble(exData[4]);
    ...
    private IEnumerator EndOfTrial2 ()
    {
        ...
        while (!done) 
        {
            ...
            {
                if ((lastcoherence > 0 & lastKey == 'f') | (lastcoherence < 0 & lastKey == 'b'))
                {
                    trialCorrect = 1;
                }
                else
